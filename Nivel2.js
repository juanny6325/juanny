    ...
    constructor() {
     ...
     create() { 
      ...
      platforms = this.physics.add.staticGroup();
         ...
         this.physics.add.overlap(player,hongos,this.quitalife,null,this)
         this.physics.add.overlap(Disparo,hongos,this.destruyehongo,null,this)
         this.life = 3 
        ...
        */
         ...
         this.scorelife = this.add.text(435, 8, "3", {fontSize: "28px", fill: "#000"});
